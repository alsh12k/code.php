...
if ($inline) {
    ...
    bot('answerInlineQuery',[
            ...
            'results' => json_encode([[
                ...
                'title'=>"هـذه الـهـمـسـة خـاصـة لـ $ex_[1] 🤍",
             'input_message_content'=>['parse_mode'=>'HTML','message_text'=>"هـذه الـهـمـسـة خـاصـة لـ $ex_[1] 🤍"],
            'reply_markup'=>['inline_keyboard'=>[
                [
                ['text'=>'🤍 عـرض الـهـمـسـة','callback_data'=>$ex_[1]."or".$username."or".$ex_[0]]
                ],
             ]]
          ]])
        ]);
